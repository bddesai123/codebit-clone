...
const Sidebars = () => {
  return (
    <div className="h-screen text-black flex">
      <Sidebar className="" icon={<FaAlignJustify />}>
        <Menu>
          ...
          <SubMenu label="FLUSHOUT TRANSFER" icon={<FaDollarSign />}>
            <MenuItem  component={<Link to="/flushouttransfer"/>} >TRANSFER</MenuItem>
          ...
          <SubMenu label="TOP-UP" icon={<FaMoneyBill />}>
            ...
            <MenuItem  component={<Link to="/topuphistory"/>}     >TOP-UP HISTORY</MenuItem>
          </SubMenu>
          <SubMenu label="FUNDS" icon={<FaMoneyBill1Wave />}>
            <MenuItem  component={<Link to="/addfunds"/>} >ADD FUND</MenuItem>
            <MenuItem  component={<Link to="/fundhistory"/>} >FUND HISTORY</MenuItem>
          </SubMenu>
          <SubMenu label="WITHDRAW" icon={<FaMoneyCheck />}>
            <MenuItem  component={<Link to="/withdraw"/>}  href="/">WITHDRAW</MenuItem>
            <MenuItem  component={<Link to="/withdrawhistory"/>}  href="/">WITHDRAW HISTORY</MenuItem>
          </SubMenu>
          <SubMenu label="SUPPORT" icon={<FaHeadset />}>
            <MenuItem  component={<Link to="/support"/>}  href="/" icon={<FaHeadset />}>
              SUPPORT
            </MenuItem>
            <MenuItem  component={<Link to="/allsupport"/>}  href="/" icon={<FaHeadset />}>
              ALL SUPPORT
            </MenuItem>
          </SubMenu>
          <MenuItem  component={<Link to="/login"/>}  icon={<FaRegCircleRight />}>LOGOUT</MenuItem>
        </Menu>
      </Sidebar>
    </div>
  );
