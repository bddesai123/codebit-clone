            ...
            <tbody>
              {rebirthData.map((rebirth, index) => (
                <tr key={index}>
                  ...
                  <td className="py-2 text-center px-4">{rebirth.userId}</td>
                  <td className="py-2 text-center px-4">{rebirth.level}</td>
                  <td className="py-2 text-center px-4">{rebirth.name}</td>
                  <td className="py-2 text-center px-4">{rebirth.date}</td>
